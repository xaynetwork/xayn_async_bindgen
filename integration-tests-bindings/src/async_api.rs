...
#[no_mangle]
pub extern "C" fn async_bindgen_dart_c__async_api__add(
    x: u8,
    y: u8,
    ...
    match ::async_bindgen::dart::PreparedCompleter::new(
        ...
        Ok(completer) => {
            completer.spawn(AsyncApi::add(x, y));
            1
        }
        Err(_) => 0,
    }
...
#[no_mangle]
pub unsafe extern "C" fn async_bindgen_dart_r__async_api__add(handle: i64) -> u8 {
    unsafe { ::async_bindgen::dart::PreparedCompleter::extract_result(handle) }
}
#[doc = r" Wrapper for initiating the call to an async function."]
#[no_mangle]
pub extern "C" fn async_bindgen_dart_c__async_api__sub(
    x: u8,
    y: u8,
    async_bindgen_dart_port_id: ::async_bindgen::dart::DartPortId,
    async_bindgen_dart_completer_id: i64,
    ...
    match ::async_bindgen::dart::PreparedCompleter::new(
        ...
        Ok(completer) => {
            completer.spawn(AsyncApi::sub(x, y));
            1
        }
        Err(_) => 0,
    }
...
#[doc = r" See the language specific version of `PreparedCompleter::extract_result()`."]
#[no_mangle]
pub unsafe extern "C" fn async_bindgen_dart_r__async_api__sub(handle: i64) -> u8 {
    unsafe { ::async_bindgen::dart::PreparedCompleter::extract_result(handle) }
}
